...
class Command(BaseCommand):
    ...
    def _create_jobs(self, recruiters):
        self.stdout.write("💼 Đang tạo Jobs...")
        if not recruiters:
            self.stdout.write(self.style.WARNING("⚠️ Không có nhà tuyển dụng nào được duyệt!"))
            return []

        # Tạo Categories & Locations & Tags
        ...
        tags = [Tag.objects.get_or_create(name=n)[0] for n in ["Java", "Python", "React", "Fullstack"]]
