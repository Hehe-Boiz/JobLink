...
class Command(BaseCommand):
    help = "Build and freeze CareerRAGBench-Auto-V3 (silver benchmark)."
    ...
    def handle(self, *args, **options) -> None:
        ...
        self.stdout.write(self.style.SUCCESS(f"CareerRAGBench-Auto-V3 frozen at {result['output_dir']}"))
        self.stdout.write(
